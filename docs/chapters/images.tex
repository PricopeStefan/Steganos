...
% talk about IDAT, IEND, IHDR, bLob, eXIf, tEXt. talk about zlib compression inside IDAT and how to decompress before doing anything. talk about lsb inside IDAt, metadata inside bLob  and writing after IEND. Shouldn't take much
\end{multicols*}
